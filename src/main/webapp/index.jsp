...
<head>
	...
	<!-- 配置文件 -->
	<script type="text/javascript" src="statics/js/ueditor.config.js"></script>
	<!-- 编辑器源码文件 -->
	<script type="text/javascript" src="statics/js/ueditor.all.js"></script>
	<style type="text/css">
		  body {
		       padding-top: 60px;
		       padding-bottom: 40px;
...
<div class="container">
	<div class="row-fluid">
		<div class="col-md-3">
			<div class="data_list">
				<div class="data_list_title"><span class="glyphicon glyphicon-user"></span>&nbsp;个人中心&nbsp;&nbsp;&nbsp;&nbsp;<a href="user?action=loginout">退出</a></div>
				<div class="userimg">
					<img src="user?action=userHead&fn=${user.head}">
				</div>
				<div class="nick">${user.nick}</div>
				<div class="mood"><c:if test="${!empty user.mood }">(${user.mood})</c:if></div>
			</div>	
			<div class="data_list">
			...
			<div class="data_list">
				...
				<div>
					<ul class="nav nav-pills nav-stacked">
						...
						<li><a href="http://localhost:8080/cloudnote/main?act=searchType&amp;val=3&amp;valStr=%E5%B0%9A%E5%AD%A6%E5%A0%82%E7%AC%94%E8%AE%B0">尚学堂笔记 <span class="badge">12</span></a></li>
						...
						<li><a href="http://localhost:8080/cloudnote/main?act=searchType&amp;val=4&amp;valStr=%E8%80%81%E8%A3%B4%E8%AF%AD%E5%BD%95">老裴语录 <span class="badge">9</span></a></li>
